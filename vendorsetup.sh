...
git clone --depth=1 https://github.com/mnrniloy/vendor_oneplus_hotdog.git -b 14 vendor/oneplus/hotdog
echo ""

# URL of the ZIP file
zip_url="https://sourceforge.net/projects/niloysbuild/files/firmware_oneplus7tPro.zip/download"

# Destination directory for extraction
extract_dir="vendor/oneplus/hotdog/"
extract_dir_check="vendor/oneplus/hotdog/radio"
